...
<body>
    ...
    <main class="main-content">
        <div class="content-box">
            <div class="bg-gray-400 rounded-lg flex flex-col justify-center items-center w-[300px] h-[150px] gap-2.5 p-5">
                <p class="text-center text-blue-800 font-poppins font-bold text-base">Belum ada surat yang diajukan</p>
            ...
            <div class="bg-gray-400 rounded-lg flex justify-center items-center w-[600px] h-[150px]">
                <p class="text-blue-800 font-poppins font-bold text-4xl">Pengajuan Surat</p>
            </div>
        </div>
        ...
        <div class="popup" id="popup">
            <h3 class="text-lg font-bold mb-2">Jenis Surat</h3>
            <div class="space-y-5">
    ...
    <script>
        ...
        function redirectToRoute() {
            ...
            let route;
            if (jenisSurat === 'Surat Rekomendasi') {
                route = "{{ route('pengajuan.rokumendasi') }}";
            } else if (jenisSurat === 'Surat Beasiswa') {
                route = "{{ route('beasiswa') }}";
            } else {
