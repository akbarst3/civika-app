    ...
    <div class="container mt-4">
        <div class="row">
            ...
            <div class="col-md-6">
                <!-- Buttons Section -->
                <div class="mb-4">
                   <a href="{{ route('daftar-verifikasi-surat') }}" class="btn text-white text-center text-2xl font-bold d-flex align-items-center justify-content-center" style="width: 600px; height: 130px; background: linear-gradient(90deg, #F24E1E 0%, #FF9A36 100%);">
