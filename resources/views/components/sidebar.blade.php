...
{{--                    <li class="nav-item">--}}
{{--                        <a href="{{ route('data-kp-pkl.import-form') }}" class="nav-link text-dark">--}}
{{--                            <i class="fas fa-file-excel me-2"></i> Import Excel KP PKL--}}
{{--                        </a>--}}
{{--                    </li>--}}
{{--                    <li class="nav-item">--}}
{{--                        <a href="{{ route('data-kp-pkl') }}" class="nav-link text-dark">--}}
...
{{--                <ul class="nav nav-pills flex-column ms-4">--}}
{{--                    <li class="nav-item">--}}
{{--                        <a href="{{ route('data-kp-pkl.generate-laporan-form') }}" class="nav-link text-dark">--}}
{{--                            <i class="fas fa-file-excel me-2"></i> KP/PKL--}}
{{--                        </a>--}}
{{--                    </li>--}}
{{--                    <li class="nav-item">--}}
{{--                        <a href="" class="nav-link text-dark">--}}
{{--                            <i class="fas fa-table me-2"></i> TA--}}
{{--                        </a>--}}
{{--                    </li>--}}
{{--                </ul>--}}
{{--            </div>--}}
