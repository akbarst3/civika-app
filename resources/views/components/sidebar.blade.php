    ...
    <nav class="nav nav-pills flex-column gap-3 sidebar-nav mt-3" style="font-size: 15px;">
        ...
        <div class="w-100">
            ...
            <div x-show="active === 'mahasiswa'" x-transition.duration.300ms class="ps-4 mt-1" x-cloak>
                <a href="{{route('data-mahasiswa.list')}}" class="d-block nav-link text-dark py-1 ps-4">Data Mahasiswa</a>
                <a href="{{route('data-mahasiswa.import')}}" class="d-block nav-link text-dark py-1 ps-4">Import Mahasiswa</a>
            </div>
        </div>
        ...
        <div class="w-100">
            ...
            <div x-show="active === 'ta'" x-transition.duration.300ms class="ps-4 mt-1" x-cloak>
                ...
                <a href="{{route('data-ta.import')}}" class="d-block nav-link text-dark py-1 ps-4">Import Excel</a>
                <a href="{{route('data-ta.generate.pdpt.form')}}" class="d-block nav-link text-dark py-1 ps-4">Laporan PDPT</a>
                <a href="{{route('data-ta.honor.form')}}" class="d-block nav-link text-dark py-1 ps-4">Laporan Honor</a>
            </div>
        </div>
        ...
        <div class="w-100">
            ...
            <div x-show="active === 'kp'" x-transition.duration.300ms class="ps-4 mt-1" x-cloak>
                ...
                <a href="{{route('data-kp-pkl')}}" class="d-block nav-link text-dark py-1 ps-4">Data KP</a>
                <a href="{{route('data-kp-pkl.import-form')}}" class="d-block nav-link text-dark py-1 ps-4">Import Excel</a>
                <a href="{{route('data-kp-pkl.generate-pdpt-form')}}" class="d-block nav-link text-dark py-1 ps-4">Laporan PDPT</a>
                <a href="{{route('data-kp-pkl.generate-honor-form')}}" class="d-block nav-link text-dark py-1 ps-4">Laporan Honor</a>
            </div>
        </div>
